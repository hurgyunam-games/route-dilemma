...
- `enemy-wisp-walk.png` / `enemy-wisp-attack.png` / `enemy-wisp-death.png` (돌진 위습)
- `enemy-wasp-walk.png` / `enemy-wasp-attack.png` / `enemy-wasp-death.png` (돌진 말벌)
- `enemy-drake-walk.png` / `enemy-drake-attack.png` / `enemy-drake-death.png` (돌진 비룡기수)
